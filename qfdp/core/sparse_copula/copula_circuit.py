...
from qfdp.core.state_prep import (
...
def encode_sparse_copula(
    ...
    **CORE BREAKTHROUGH FUNCTION**
    ...
    --------
    >>> import numpy as np
    >>> from qfdp.core.sparse_copula import FactorDecomposer, encode_sparse_copula
    >>> 
    >>> # 3-asset portfolio
    >>> asset_params = [
...
def encode_sparse_copula_with_decomposition(
    ...
    --------
    >>> import numpy as np
    >>> from qfdp.core.sparse_copula import encode_sparse_copula_with_decomposition
    >>> 
    ...
    """
    from qfdp.core.sparse_copula import FactorDecomposer
...
def estimate_copula_resources(
    ...
    Examples
    --------
    >>> from qfdp.core.sparse_copula import estimate_copula_resources
    >>> 
    ...
    """
    from qfdp.core.state_prep import estimate_resource_cost
