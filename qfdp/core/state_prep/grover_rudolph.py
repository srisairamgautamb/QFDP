...
def prepare_marginal_distribution(
    ...
    --------
    >>> import numpy as np
    >>> from qfdp.core.state_prep import prepare_marginal_distribution
    >>> 
...
def prepare_gaussian_factor(
    ...
    Examples
    --------
    >>> from qfdp.core.state_prep import prepare_gaussian_factor
    >>> 
...
def prepare_lognormal_asset(
    ...
    Examples
    --------
    >>> from qfdp.core.state_prep import prepare_lognormal_asset
    >>> 
